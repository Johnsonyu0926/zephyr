...
SHELL_SUBCMD_ADD((wifi), disconnect, NULL, "Disconnect from the Wi-Fi AP.\n",
		cmd_wifi_disconnect,
		1, 0);
SHELL_SUBCMD_ADD((wifi), ps, NULL, "Configure or display Wi-Fi power save state.\n"
		"[on/off]\n",
		cmd_wifi_ps,
		1, 1);
SHELL_SUBCMD_ADD((wifi), ps_mode,
		NULL,
		"<mode: legacy/WMM>.\n",
		cmd_wifi_ps_mode,
		2, 0);
SHELL_SUBCMD_ADD((wifi), scan, NULL,
		...
		cmd_wifi_scan,
		1, 8);
SHELL_SUBCMD_ADD((wifi), statistics, NULL, "Wi-Fi interface statistics.\n"
...
SHELL_SUBCMD_ADD((wifi), reg_domain, NULL,
	...
	cmd_wifi_reg_domain,
	1, 2);
SHELL_SUBCMD_ADD((wifi), mode, NULL, "mode operational setting\n"
	...
	cmd_wifi_mode,
	1, 9);
SHELL_SUBCMD_ADD((wifi), packet_filter, NULL, "mode filter setting\n"
	...
	2, 8);
SHELL_SUBCMD_ADD((wifi), channel, NULL, "wifi channel setting\n"
