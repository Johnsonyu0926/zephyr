...
#ifdef CONFIG_WIFI_CREDENTIALS_SHELL
...
#endif /* CONFIG_WIFI_CREDENTIALS_SHELL */
...
SHELL_STATIC_SUBCMD_SET_CREATE(wifi_commands,
	...
	SHELL_CMD_ARG(add, NULL, "Add network to storage.\n", cmd_add_network, 0, 0),
	SHELL_CMD_ARG(delete, NULL, "Delete network from storage.\n", cmd_delete_network, 0, 0),
	SHELL_CMD_ARG(list, NULL, "List stored networks.\n", cmd_list_networks, 0, 0),
#endif /* CONFIG_WIFI_CREDENTIALS */
#ifdef CONFIG_WIFI_CREDENTIALS_CONNECT_STORED
	SHELL_CMD_ARG(auto_connect, NULL, "Connect to any stored network.\n",
