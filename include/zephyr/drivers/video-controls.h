...
#define VIDEO_CID_HFLIP			(VIDEO_CTRL_CLASS_BASE + 0)
/** Mirror the picture vertically */
#define VIDEO_CID_VFLIP			(VIDEO_CTRL_CLASS_BASE + 1)
/**
 * @}
 */
 ...
 * @{
 */
#define VIDEO_CID_CAMERA_EXPOSURE	(VIDEO_CTRL_CLASS_CAMERA_BASE + 0)
#define VIDEO_CID_CAMERA_GAIN		(VIDEO_CTRL_CLASS_CAMERA_BASE + 1)
#define VIDEO_CID_CAMERA_ZOOM		(VIDEO_CTRL_CLASS_CAMERA_BASE + 2)
#define VIDEO_CID_CAMERA_BRIGHTNESS	(VIDEO_CTRL_CLASS_CAMERA_BASE + 3)
#define VIDEO_CID_CAMERA_SATURATION	(VIDEO_CTRL_CLASS_CAMERA_BASE + 4)
#define VIDEO_CID_CAMERA_WHITE_BAL	(VIDEO_CTRL_CLASS_CAMERA_BASE + 5)
#define VIDEO_CID_CAMERA_CONTRAST	(VIDEO_CTRL_CLASS_CAMERA_BASE + 6)
#define VIDEO_CID_CAMERA_COLORBAR	(VIDEO_CTRL_CLASS_CAMERA_BASE + 7)
#define VIDEO_CID_CAMERA_QUALITY	(VIDEO_CTRL_CLASS_CAMERA_BASE + 8)
/**
 * @}
 */
